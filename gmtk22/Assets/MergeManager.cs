        ...
        if (!lockMerge)
        {
            ...
            if (dice1Num < -100 || dice2Num < -100)
            {
                ...
                if (dice1Num > 0)
                {
                    ...
                    GameObject dice1New = Instantiate(mergeDiePrefab, positionNew + new Vector3(0.5f,0,0), Quaternion.identity);
                    ...
                    GameObject dice2New = Instantiate(mergeDiePrefab, positionNew - new Vector3(0.5f,0,0), Quaternion.identity);
